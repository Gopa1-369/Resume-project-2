...
//unique resource identifier,provide use unique ID fro each one of our posts
...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  console.log("postedBy.userName:", postedBy?.userName);
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="blank"
                  rel="noreferrer"
                  className="bg-white flex items-center gap-2 tet-black font-bold p-2 pl-3 pr-4 rounded-full opacity-70 hoever:100 hover:shadow-md"
                >
